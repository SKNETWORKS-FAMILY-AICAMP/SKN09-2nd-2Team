...
#### 고유 곡 대비 총 청취시간 비율 분석
> 이탈한 사람 is_churn : 1, 이탈하지 않은 사람 is_churn : 0
<div align="center">
<img src="./readme_images/sw_eda_2.png" height="70%", width="70%">
</div>

* 이탈하지 않은 고객: 2000-6000 사이의 사용자가 가장 많지만, 6000이상인 사용자 수도 상당하다.
    * 특정 곡에 대한 충성도가 높은 사용자가 많다.
* 이탈한 고객: 고유 곡의 총 청취 시간 비율이 6000이상인 사용자가 압도적으로 많다.
    * 특정 곡에만 집중적으로 청취하고 다른 곡에는 관심을 보이지 않아 이탈로 이어졌을 가능성을 시사한다.
...
- 이재혁 : 
- 전성원 : randomOverSampling을 사용하거나, 사용하는 방법에 대해서 많이 배웠고, 좋은 팀원들을 만나서 더 완성도 높고 퀄리티 있는 프로젝트를 진행한거 같습니다. :hugging: 
